// Network configuration and state management for simple-crypto-wallet.
// Handles network selection (undeployed / preview / preprod), wallet seed
// persistence, and deployment record tracking.
