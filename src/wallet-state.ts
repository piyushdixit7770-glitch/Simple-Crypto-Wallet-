// Wallet sync-state persistence for simple-crypto-wallet.
// Pure I/O — no SDK imports, no template substitutions.
// wallet.ts is the glue between this format and the wallet SDK.
